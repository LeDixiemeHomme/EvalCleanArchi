...
public class Run
{
	...
	public String ProcessPrint(string[] dataContentString)
	{
	...
	public String ProcessReport(string[] dataContentString)
	{
	...
	public void Exec(string[] args)
    {
    		...
    		if (command == "print")
    		{
	            Console.Write(ProcessPrint(dataContentString: dataContentString));
	            
	            // if command is report
    		}
    		else if (command == "report")
            {
	            Console.Write(ProcessReport(dataContentString: dataContentString));
            }
    		else
    		{
	            Console.Write(ProcessUnknown());
            }
    }
}
...
public class Run
{
	...
	public void ProcessPrint(string[] dataContentString)
	{
		//get the header line  
	...
	public void ProcessReport(string[] dataContentString)
	{
	...
	public void Exec(string[] args)
    {
    		...
    		if (command == "print")  
    		{  
	            // ProcessPrint(dataContentString);
    		...
    		{  
	            // ProcessReport(dataContentString);
